...
export const scenes: Record<SceneName, Scene> = {
  immersive: {
    ...
    bgDarker: '#0A331F',
    bgBright: '#1F7148',
    accentPrimary: '#E6C982',
    accentSecondary: '#C9A961',
    accentDeep: '#B8924B',
    textPrimary: '#EFEAE0',
    textSecondary: '#BFC6BB',
    textMuted: 'rgba(239,234,224,0.74)',
    surface: 'rgba(201,169,97,0.035)',
    surfaceRaised: 'rgba(201,169,97,0.07)',
    surfaceStrong: 'rgba(201,169,97,0.12)',
    border: 'rgba(201,169,97,0.30)',
    borderSoft: 'rgba(201,169,97,0.16)',
  },
  transactional: {
    bg: '#EFEAE0',
    bgDeep: '#DCD2BF',
    bgDarker: '#CFC2AB',
    bgBright: '#F7F3EA',
    accentPrimary: '#B8924B',
    accentSecondary: '#8B6D36',
    accentDeep: '#8A6A2E',
    textPrimary: '#1F3A2E',
  ...
  editorial: {
    ...
    border: 'rgba(230,201,130,0.24)',
    borderSoft: 'rgba(230,201,130,0.14)',
  },
  emergency: {
    bg: '#0C3823',
    bgDeep: '#071F15',

...
const styles = StyleSheet.create({
  ...
  modalRoot: { flex: 1 }, modalSafe: { flex: 1 }, modalHeader: { minHeight: 72, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 11, borderBottomWidth: 1, borderBottomColor: 'rgba(207,160,85,.22)' }, close: { width: 39, height: 39, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(207,160,85,.26)', alignItems: 'center', justifyContent: 'center' }, modalEyebrow: { color: '#CFA055', fontFamily: 'Jost_700Bold', fontSize: 8, letterSpacing: 1.5 }, modalTitle: { color: '#F2EBDD', fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 24 }, modalContent: { padding: 14, paddingBottom: 35, gap: 12 }, section: { alignSelf: 'stretch', borderRadius: 15, borderWidth: 1, borderColor: '#E0D3BC', backgroundColor: '#FFFCF6', paddingHorizontal: 13, paddingBottom: 3 }, sectionLabel: { color: '#B17E2B', fontFamily: 'Jost_700Bold', fontSize: 9, letterSpacing: 1.2, paddingVertical: 11, borderBottomWidth: 1, borderBottomColor: '#EEE5D6' }, line: { minHeight: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, borderBottomWidth: 1, borderBottomColor: '#F1E9DC' }, lineLabel: { flexShrink: 0, color: '#7B8880', fontFamily: 'Jost_400Regular', fontSize: 10 }, lineValue: { flex: 1, color: '#1F3428', fontFamily: 'Jost_500Medium', fontSize: 10, textAlign: 'right' }, sectionEmpty: { color: '#7B8880', fontFamily: 'Jost_400Regular', fontSize: 10, paddingVertical: 13 }, quickActions: { flexDirection: 'row', gap: 9 }, quickButton: { flex: 1, minHeight: 48, borderRadius: 13, backgroundColor: '#CFA055', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 }, quickText: { color: '#082719', fontFamily: 'Jost_700Bold', fontSize: 9, letterSpacing: .8 },
